...
describe("action catalogue and retrieval", () => {
	...
	it("honors a canonical reminder candidate over calendar keyword competition", () => {
		const catalog = buildActionCatalog([
			{
				name: "CALENDAR",
				description:
			...
			},
			{
				...
				description:
					"Create, update, complete, and review one-off or recurring owner reminders.",
				similes: ["CREATE_REMINDER", "REMINDER_CREATE"],
			},
		]);
